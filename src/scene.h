...
class Camera {
 public:
  ...
  Matrix4x4 const &transform_matrix() { return transform_matrix_; }

  void Lookat(Point4 pos, Vector4 up, Vector4 target) { this->pos_ = pos; }
...
//         view_port_center_{(viewport_width - 1) / 2, (viewport_height - 1) /
//         2}, viewplane_width_{2.0f}, viewplane_height_{2.0f * viewport_height
//         / viewport_width} {
//
//         }
//
...
//   // 视距都为 1
//   static constexpr float viewdistance_x() { return 1.0f; }
//   static constexpr float viewdistance_y() { return 1.0f; }
//
